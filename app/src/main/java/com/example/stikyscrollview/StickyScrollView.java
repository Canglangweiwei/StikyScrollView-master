...
public class StickyScrollView extends ScrollView {
    ...
    private final int defaultShadowHeight = 10;
    ...
    private void showStickyView() {
        ...
        if (curStickyView != null) {
            mStickyViewTopOffset =
                    nextStickyView == null ? 0 : Math.min(0, nextStickyView.getTop() - getScrollY() - curStickyView.getHeight());
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        if (redirectTouchToStickyView) {
            ev.offsetLocation(0,
                    -1 * ((getScrollY() + mStickyViewTopOffset) - mCurrentStickyView.getTop()));
        }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        if (redirectTouchToStickyView) {
            ev.offsetLocation(0,
                    ((getScrollY() + mStickyViewTopOffset) - mCurrentStickyView.getTop()));
        }
